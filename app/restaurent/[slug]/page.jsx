        ...
        <div className="w-[27%] relative text-reg ">
          <div className="fixed w-[15%] bg-white rounded p-3 shadow">
            ...
            <div className="my-3 flex flex-col text-black">
              ...
              <select name="" className="py-3 border-b font-light text-white" id="">
            ...
            <div className="flex justify-between">
              <div className="flex flex-col w-[48%] text-black">
                ...
                <input type="text" className="py-3 border-b font-light w-28 text-white"  />
              </div>
              <div className="flex flex-col w-[48%] text-black">
                <label htmlFor="">Time</label>
                <select name="" id="" className="py-3 border-b font-light text-white">
